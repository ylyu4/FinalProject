...
<div class="employer_write_job_description-div">
  ...
  <form action="employer_write_job_description.jsp">
    ...
    <div>
      <input class="employer_write_job_description-form" id="jobName" type="text" name="jobName" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobCompany">Company</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobCompany" type="text" name="jobCompany" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobExperience">Experience</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobExperience" type="text" name="jobExperience" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobLocation">Location</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobLocation" type="text" name="jobLocation" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobField">Field</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobField" type="text" name="jobField" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobSalary">Salary</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobSalary" type="text" name="jobSalary" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobContact">Contact</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobContact" type="text" name="jobContact" value="" required>
    </div>
    <div>
      <label class="employer_write_job_description-form-label" for="jobDueDate">Due Date</label>
    </div>
    <div>
      <input class="employer_write_job_description-form" id="jobDueDate" type="text" name="jobDueDate" value="" required>
    </div>
  </div>
  <div class="employer_write_job_description-right">
    ...
    <button type="button" name="employer_write_job_descriptionBack" onclick= "buttonJump('http://localhost:8080/page/employer/profile')">Back</button>
  </div>
  </form>
</div>
</body>
