  ...
  <div class="freelancer_sign_up-div">
    ...
    <form action="freelancer_profile.jsp" method="">
      <div>
        ...
        <div>
        <input type="text" class="freelancer_sign_up-form" id="freelancerSignupUsername" name="freelancerAccount" required>
      </div>
      <div>
        <label class="freelancer_sign_up-form-label" for="password">Password</label>
      </div>
      <div>
        <input type= "text" class="freelancer_sign_up-form" id="freelancerSignupPassword" name="freelancerPassword" required>
      </div>
    ...
    <button type="button" name="freelancerSignUpBack" onclick="buttonJump('http://localhost:8080/page/employer/login')">Back</button>
  </div>
  </div>
</body>
